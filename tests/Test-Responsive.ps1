...
[IO.File]::WriteAllText((Join-Path $testRoot 'sibling.md'), "# Automatically discovered sibling", (New-Object Text.UTF8Encoding($false)))
...
$testSettings.behavior.showTableOfContents = $true
